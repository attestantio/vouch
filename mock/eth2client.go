...
// SubmitBlindedProposal is a mock.
func (m *SleepyBlindedProposalSubmitter) SubmitBlindedProposal(ctx context.Context, opts *api.SubmitBlindedProposalOpts) error {
	time.Sleep(m.wait)
	return m.next.SubmitBlindedProposal(ctx, opts)
}
