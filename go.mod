...
require (
	...
	github.com/attestantio/go-block-relay v0.5.2-0.20260711075753-1a650603cbff
	github.com/attestantio/go-builder-client v0.7.3-0.20260711075608-adea2e7fd783
