...
func TestBaseRelayConfig(t *testing.T) {
	tests := []struct {
		name  string
		input []byte
		err   string
		...
		},
		{
			name:  "JSONBad",
			input: []byte("[]"),
			err:   "invalid JSON: json: cannot unmarshal array into Go value of type v2.baseRelayConfigJSON",
		},
		{
			name:  "FeeRecipientWrongType",
			input: []byte(`{"fee_recipient":true,"gas_limit":"30000000","grace":"1000","min_value":"0.5"}`),
			err:   "invalid JSON: json: cannot unmarshal bool into Go struct field baseRelayConfigJSON.fee_recipient of type string",
		},
		{
		...
		},
		{
			...
			err:   "invalid JSON: json: cannot unmarshal bool into Go struct field baseRelayConfigJSON.gas_limit of type string",
		},
		{
		...
		},
		{
			...
			err:   "invalid JSON: json: cannot unmarshal bool into Go struct field baseRelayConfigJSON.grace of type string",
		},
		{
			name:  "GraceInvalid",
			input: []byte(`{"fee_recipient":"0x1111111111111111111111111111111111111111","gas_limit":"30000000","grace":"true","min_value":"0.5"}`),
		...
		},
		{
			...
			err:   "invalid JSON: json: cannot unmarshal bool into Go struct field baseRelayConfigJSON.min_value of type string",
		},
		{
