	...
	tests := []struct {
	...
	}{
		{
			...
			params: []standard.Parameter{
				...
				standard.WithVersionedAttestationsSubmitter(versionedAttestationsSubmitter),
			},
		...
		{
			name: "VersionedAttestationsSubmitterMissing",
			params: []standard.Parameter{
				standard.WithLogLevel(zerolog.Disabled),
				standard.WithMonitor(prometheusMetrics),
				standard.WithProcessConcurrency(1),
				...
				standard.WithValidatingAccountsProvider(validatingAccountsProvider),
				standard.WithBeaconAttestationsSigner(beaconAttestationsSigner),
				standard.WithVersionedAttestationsSubmitter(nil),
			},
			err: "problem with parameters: no versioned attestations submitter specified",
		},
		{
