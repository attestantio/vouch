...
func (s *Service) proposeEPBSBlock(ctx context.Context,
	...
	requestedPreference := gloasRequestedPreference(s.builderBoostFactor)
	...
	s.log.Info().
		...
		Str("source", source).
		Uint64("requested_min_bid", uint64(s.builderMinBid)).
		Uint64("builder_boost_factor", s.builderBoostFactor).
